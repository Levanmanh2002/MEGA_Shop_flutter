...
import 'package:e_commerce_application_seller/views/order_screen/components/order_place_details.dart';
              ...
              children: [
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      SwitchListTile(
                        ...
                        title: boldText(text: "Configrmed", color: fontGrey),
                      ),
                      SwitchListTile(
                        activeColor: green,
                ...
                Column(
                  children: [
                    ...
                    orderPlaceDetails(
                      d1: intl.DateFormat().add_yM().format((widget.data['order_date'].toDate())),
                          ...
                          SizedBox(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                boldText(text: "\$ ${widget.data['total_amount']}", color: purpleColor),
                              ],
                            ),
                          ),
                        ],
                ...
                const Divider(),
                10.heightBox,
                boldText(text: "Ordered Products", color: purpleColor, size: 16.0),
                10.heightBox,
                ListView(
