...
import 'package:e_commerce_application_seller/views/widgets/dashboard_button.dart';
                  ...
                  children: [
                    Row(
                      ...
                      children: [
                        ...
                        dashboardButton(context, title: order, count: "15", icon: icOrders),
                      ],
                    ),
                    10.heightBox,
                    Row(
                      ...
                      children: List.generate(
                        ...
                        (index) => data[index]['p_wishlist'].length == 0
                            ...
                            : ListTile(
                                ...
                                subtitle: normalText(text: "\$ ${data[index]['p_price']}", color: lightGrey),
                              ),
                      ),
                    ),
                  ],
