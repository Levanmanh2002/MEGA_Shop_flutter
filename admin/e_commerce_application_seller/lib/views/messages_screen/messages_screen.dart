...
import 'package:e_commerce_application_seller/views/messages_screen/chat_screen.dart';
                ...
                child: SingleChildScrollView(
                  ...
                  child: Column(
                    children: List.generate(data.length, (index) {
                      var t = data[index]['created_on'] == null ? DateTime.now() : data[index]['created_on'].toData();
