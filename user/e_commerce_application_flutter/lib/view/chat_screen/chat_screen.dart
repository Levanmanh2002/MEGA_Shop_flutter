...
import 'package:e_commerce_application_flutter/controller/chat_controller.dart';
import 'package:e_commerce_application_flutter/services/firebase_services.dart';
import 'package:e_commerce_application_flutter/view/chat_screen/components/sender_bubble.dart';
          ...
          children: [
            Obx(
              () => controller.isLoading.value
                  ...
                  : Expanded(
                      child: StreamBuilder(
                        stream: FirebaseService.getChatMessage(controller.chatDocId.toString()),
